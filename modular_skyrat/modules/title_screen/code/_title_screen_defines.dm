...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_zzplurt/icons/UI_Icons/title_screen/splurt_banner_background.png' // REGZT EDIT START: TITLE SCREEN - old value: 'modular_zzplurt/icons/UI_Icons/title_screen/splurt_banner_background.png' old old value: 'modular_skyrat/modules/title_screen/icons/skyrat_title_screen.png'
